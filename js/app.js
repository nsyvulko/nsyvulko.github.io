...
AP.init({
  playList: [
  	{'title': 'RHCP-snow', 'file': 'audio/red-hot-chili-peppers-snow-hey-oh-(mp3-crazy.com).mp3'},
    {'title': 'RHCP-californication', 'file': 'audio/red-hot-chili-peppers-californication-(mp3-crazy.com).mp3'},
    {'title': 'THE HARDKISS - Helpless', 'file': 'audio/01_the_hardkiss_helpless_myzuka.fm.mp3'} 
  ]
});
